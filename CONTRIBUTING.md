...
백엔드 담당자가 1명뿐이므로(2026-08-01 임채영 팀 이탈 이후) 사람 교차 리뷰를 강제할 수 없습니다. 대신 변경 위험도에 따라 확인 기준을 나눕니다.

### 리뷰 필수

아래 변경은 자동 리뷰 봇(claude-review · codex-review) 결과를 확인하고, 지적 사항을 해소하거나 반영하지 않는 사유를 남긴 뒤 머지합니다.
...
긴급 수정은 봇 리뷰 확인 전에 먼저 머지할 수 있지만, 머지 후 봇 지적 사항을 확인해 필요한 후속 수정을 합니다.

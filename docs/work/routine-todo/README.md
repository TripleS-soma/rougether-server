...
| 루틴 완료/취소 API | [routine-logs.md](routine-logs.md) | 0 | 확정 (위험영역·reviewer 필수, `/run-plan routine-todo/routine-logs` 대상) |
| 투두 CRUD+완료/취소 API | [todos.md](todos.md) | 0 | 확정 (위험영역·reviewer 필수, `/run-plan routine-todo/todos` 대상) |
...
| 오늘 현황(/today) API | [today.md](today.md) | 0 | 확정 (읽기 전용, `/run-plan routine-todo/today` 대상) |

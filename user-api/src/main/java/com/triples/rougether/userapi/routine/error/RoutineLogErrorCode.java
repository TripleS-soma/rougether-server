...
public enum RoutineLogErrorCode implements ErrorCode {
    ...
    ALREADY_COMPLETED("ALREADY_COMPLETED", "이미 완료한 루틴입니다.", 409),
    LOG_NOT_CANCELABLE("LOG_NOT_CANCELABLE", "미래 날짜는 취소할 수 없습니다.", 409),
    ...
    INVALID_ROUTINE_DATE("INVALID_ROUTINE_DATE", "미래 날짜는 완료할 수 없습니다.", 400),
    SKIP_DATE_NOT_ALLOWED("SKIP_DATE_NOT_ALLOWED", "지난 날짜는 건너뛸 수 없습니다.", 400);

...
public final class GachaGiftBoxCatalog {
    ...
    private static final Map<String, String> ASSET_KEY_BY_THEME_CODE = Map.ofEntries(
            ...
            Map.entry("calm_hanok", "items/643162b1-276e-4c93-98cb-9a5c706f677f.png"),
            Map.entry("bakery_morning", "items/7ae25d25-e15b-413b-ba97-650a1645514f.png"),
            Map.entry("cozy_space", "items/0ee18a21-a533-4342-aee7-fae4828897d6.png"),
            Map.entry("rainy_afternoon_study",
                    "items/a13c2174-53ec-4ee0-bcd9-3bdc86863965.png"),
            Map.entry("onsen_bath_routine",
                    "items/2b4e84ed-7c21-4efa-9dbd-c5095d5c87f6.png"),
            Map.entry("cloud_nap_room",
                    "items/6444611a-fd13-48ab-b1a0-4d7d979ac920.png"),
            Map.entry("stationery_study_room",
                    "items/7cd56955-5318-40ba-98a3-1b048c8dbd09.png"),
            Map.entry("cozy_developer_room", "items/8c3933ba-f466-4362-b77b-fa82d107e26f.png"),
            Map.entry("pastel_cyberpunk_room", "items/5da707d5-0865-4533-b724-a060d1a73e29.png"),
            Map.entry("cozy_zombie_hideout", "items/952e7591-e00a-48c1-b187-187eabcad07d.png"),
            Map.entry("summer_beach_room", "items/441fbbfb-c09b-4b74-b4ef-c36e0616fea5.png"));

...
public enum HouseErrorCode implements ErrorCode {
    ...
    HOUSE_OWNER_TRANSFER_TO_BOT("HOUSE_OWNER_TRANSFER_TO_BOT", "봇 구성원에게는 소유권을 양도할 수 없습니다.", 400),
    ...
    HOUSE_ORDER_INVALID("HOUSE_ORDER_INVALID", "집 순서는 현재 참여 중인 집 전체를 중복 없이 포함해야 합니다.", 400),
    ...
    HOUSE_NAME_BANNED("HOUSE_NAME_BANNED", "집 이름에 사용할 수 없는 단어가 포함되어 있습니다.", 400),
    GUESTBOOK_CONTENT_BANNED("GUESTBOOK_CONTENT_BANNED", "방명록에 사용할 수 없는 단어가 포함되어 있습니다.", 400),
    HOUSE_MISSION_TITLE_BANNED("HOUSE_MISSION_TITLE_BANNED", "미션 제목에 사용할 수 없는 단어가 포함되어 있습니다.", 400),
    ...
    HOUSE_JOIN_REQUEST_ALREADY_PENDING("HOUSE_JOIN_REQUEST_ALREADY_PENDING", "이미 입주 신청 중인 집입니다.", 409),
    HOUSE_JOIN_REQUEST_NOT_PENDING("HOUSE_JOIN_REQUEST_NOT_PENDING", "대기 중인 입주 신청이 아닙니다.", 409),
    HOUSE_JOIN_REQUEST_NOT_FOUND("HOUSE_JOIN_REQUEST_NOT_FOUND", "존재하지 않는 입주 신청입니다.", 404),
    HOUSE_JOIN_REQUEST_APPLICANT_WITHDRAWN("HOUSE_JOIN_REQUEST_APPLICANT_WITHDRAWN",
            "탈퇴한 사용자의 입주 신청입니다.", 409),

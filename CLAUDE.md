...
백엔드는 1인 개발 체제이며, 모든 백엔드 도메인(루틴·투두·회원·방·집·뽑기·상점·캐릭터·보상·미션·알림·DB·인프라·AI)을 이 레포에서 직접 결정하고 구현합니다. 미정값은 open question으로 표시하고 spec repo에서 관리합니다.
...
- 친구 초대, 초대 링크/딥링크 → [docs/claude/domains/invite.md](docs/claude/domains/invite.md)

package com.triples.rougether.furniture.error;
...
public enum FurnitureGenerationErrorCode implements ErrorCode {
    ...
    FURNITURE_QUEUE_FULL("가구 생성 요청이 많습니다. 잠시 후 다시 시도해 주세요.", 503),
    FURNITURE_UPLOAD_BUSY("사진을 처리 중입니다. 잠시 후 다시 시도해 주세요.", 503),
    FURNITURE_ADMISSION_BUSY("가구 생성 접수가 지연되고 있습니다. 잠시 후 다시 시도해 주세요.", 503);
